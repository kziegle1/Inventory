...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void saveInventory() {
        ...
        // and Stellaluna's book attributes are the values.
        ContentValues values = new ContentValues();
        values.put(InventoryEntry.COLUMN_BOOK_NAME, "Stellaluna");
        values.put(InventoryEntry.COLUMN_BOOK_SUPPLIER_PHONENUMBER, "206.244.4444");
        values.put(InventoryEntry.COLUMN_BOOK_SUPPLIER, InventoryEntry.SUPPLIER_SCHOLASTIC);
        values.put(InventoryEntry.COLUMN_BOOK_PRICE, 6.99);
        values.put(InventoryEntry.COLUMN_BOOK_PRICE, 7);

        // Insert a new row for Stellaluna into the provider using the ContentResolver.
        // Use the {@link InventoryEntry#CONTENT_URI} to indicate that we want to insert
        // into the inventory database table.
        // Receive the new content URI that will allow us to access Stellaluna's data in the future.
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        // Update {@link InventoryCursorAdapter} with this new cursor containing updated book data
